...
<section class="no-results not-found is-layout-constrained">
	...
	<header class="page-header has-global-padding">
		<h1 class="page-title"><?php esc_html_e( 'Nothing Found', 'ng_s' ); ?></h1>
	</header><!-- .page-header -->
	...
	<div class="page-content has-global-padding">
		<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
			...
			printf(
				wp_kses(
					...
					esc_html__( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'ng_s' ),
					[
						'a' => [
							'href' => [],
						],
		...
		<?php elseif ( is_search() ) : ?>
			<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'ng_s' ); ?></p>
			<?php get_search_form(); ?>
		<?php else : ?>
